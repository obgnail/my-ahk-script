General:
    ...
    ; obgnail use
    vim.SetAction("<ChangeTypewriting>", "切换输入法")
    vim.SetAction("<SwitchLeftDesk>", "切换左边虚拟桌面")
    vim.SetAction("<SwitchRightDesk>", "切换右边虚拟桌面")
    vim.SetAction("<OpenEverything>", "打开everything")
    vim.SetAction("<TaskList>","任务列表")
    vim.SetAction("<ActivateTask1>","切换到第1个任务")
    vim.SetAction("<ActivateTask2>","切换到第2个任务")
    vim.SetAction("<ActivateTask3>","切换到第3个任务")
    vim.SetAction("<ActivateTask4>","切换到第4个任务")
    vim.SetAction("<ActivateTask5>","切换到第5个任务")
    vim.SetAction("<ActivateTask6>","切换到第6个任务")
    vim.SetAction("<DeleteLine>","删除一整行")
    vim.SetAction("<PreWord>","光标跳转到上一个单词")
    vim.SetAction("<NextWord>","光标跳转到下一个单词")
    vim.SetAction("<ESC>","esc键")
